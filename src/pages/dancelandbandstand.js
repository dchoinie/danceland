  ...
  return (
    <Layout>
      ...
      <p>
        ...
        Bandstand. He called it Danceland Bandstand, natch. The dances were held
        on Sunday afternoons from 2-5 PM and telecast over KCRG-TV from 3-4.
        Local KCRG radio disc jockeys (Dave Etzel, Jim Young, Jim Jensen) served
        as the host/emcee. The dances were for ages 13-18. Dress-up rules
        applied and parents were always welcome. It ran for two seasons. Both
        seasons featured a combination of records hops, local live music and an
        occasional national act. Sometimes a national act would play Saturday
        night and hold over for the Sunday slot.
      </p>
